		            ...
		            foreach($apps as $obj)
		                     { // Vrti po redovima
		                     		...
		                     		if ($selectbox2!='')
									{
										...
										$selectCreate = "<select  class=\"form-control\" id=\"{$kolona}\" {$is_nullable} {$crud['tip_kolone']}>{$selectCreateBody}</select>";
									}
		                     		//echo $obj->tip.'<br>';
		                     		if ($obj->tip == 'character varying')
		                     		{
		                     			if ($selectbox2 =='')
		                     			{
			                     			...
			                     			" 
						                       ...
						                       <input type=\"text\"  class=\"form-control\" title=\"{$opis}\" data-toggle=\"popover\" data-html=\"true\" data-trigger=\"manual\"  data-content=\"\" placeholder=\"{$kolona} *\" id=\"{$kolona}\" {$is_nullable} {$crud['tip_kolone']} />
						                            </div>
					                        	</div>
				                        	";
			                        	}
		                     			...
		                     			if ($selectbox2 =='')
		                     			{
			                     			...
			                     			" 
				                     			<div class=\"col-md-4\">
						                            <div class=\"form-group\">
						                            	<label>".strtoupper($kolona)."</label>
						                                <input type=\"number\" step=\"any\" class=\"form-control\" title=\"{$opis}\" placeholder=\"{$kolona} *\" id=\"{$kolona}\" {$is_nullable} {$crud['tip_kolone']} />
						                            </div>
					                        	</div>
				                        	";
				                        }
		                     		...
		                     		elseif ($obj->tip == 'timestamp without time zone')
		                     		{
			                     			...
			                     			" 
				                     			<div class=\"col-md-4\">
						                            <div class=\"form-group\">
						                            	<label>".strtoupper($kolona)."</label>
						                                <input type=\"datetime\" class=\"form-control datumVreme\" title=\"{$opis}\" placeholder=\"{$kolona} *\" id=\"{$kolona}\" {$is_nullable} {$crud['tip_kolone']} />
						                            </div>
					                        	</div>
				                        	";
		                     		}
		           	...
		           	foreach ($proveriInsertKey as $red) 
		           		{
							 ...
							 $postojiPk = new $this->modelName;
		           			...
		           			$postojiPk->where($uslovZaProveru)->first();

		           			if ($postojiPk != null && count($proveriInsertValue)<1) 
		           			{

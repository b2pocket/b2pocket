...
use Carbon\Carbon;
use Laravel\adminModels\helena_setovanje as helset;
use Laravel\adminModels\crud_edit_settings as crudSettings;

class setovanjeTransferaController extends Controller
{
     ...
     public function setovanjeTransferaIndex()
    {
      ...
      foreach(json_decode($prom) as $obj){
			...
			//echo $this->tabela;
        return view('admin/setovanje_transfera',compact('param','param2'));	
